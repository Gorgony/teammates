...
public class InstructorFeedbackQuestionVisibilityMessageActionTest extends BaseActionTest {
    ...
    public void testExecuteAndPostProcess() {
        String instructor1OfCourse1 = dataBundle.getInstructors().get("instructor1OfCourse1").googleId;
        ...
        fs = dataBundle.getFeedbackSessions().get("session2InCourse1");
        ...
        fs = dataBundle.getFeedbackSessions().get("gracePeriodSession");
        fq = FeedbackQuestionsLogic.inst().getFeedbackQuestion(fs.getFeedbackSessionName(), fs.getCourseId(), 1);
        ...
        String instructor1OfCourse2 = dataBundle.getInstructors().get("instructor1OfCourse2").googleId;

        gaeSimulation.logoutUser(); // log out of instructor 1
        gaeSimulation.loginAsInstructor(instructor1OfCourse2);

        fs = dataBundle.getFeedbackSessions().get("session1InCourse2");
        fq = FeedbackQuestionsLogic.inst().getFeedbackQuestion(fs.getFeedbackSessionName(), fs.getCourseId(), 1);
