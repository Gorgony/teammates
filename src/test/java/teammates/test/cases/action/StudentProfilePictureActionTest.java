...
public class StudentProfilePictureActionTest extends BaseActionTest {
    ...
    public void classSetup() {
        account = dataBundle.getAccounts().get("student1InCourse1");
    ...
    private void testActionWithEmailAndCourse() throws Exception {
        AccountAttributes instructor = dataBundle.getAccounts().get("instructor1OfCourse1");
    ...
    private InstructorAttributes createNewInstructorForUnregCourse()
            throws Exception {
        String course = dataBundle.getCourses().get("unregisteredCourse").getId();
    ...
    private void testActionForStudentWithEmptyGoogleId() {
        ...
        StudentAttributes student = dataBundle.getStudents().get("student2InUnregisteredCourse");
    ...
    private void testActionWithEmailAndCourseUnauthorisedInstructorOrStudent() {
        ...
        AccountAttributes unauthInstructor = dataBundle.getAccounts().get("instructor1OfCourse2");
        ...
        unauthInstructor = dataBundle.getAccounts().get("helperOfCourse1");
        gaeSimulation.loginAsInstructor(unauthInstructor.googleId);
        ...
        AccountAttributes unauthStudent = dataBundle.getAccounts().get("student1InArchivedCourse");
        ...
        StudentAttributes studentFromDifferentTeam = dataBundle.getStudents().get("student5InCourse1");
