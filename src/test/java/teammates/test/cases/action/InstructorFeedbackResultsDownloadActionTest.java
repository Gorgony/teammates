...
public class InstructorFeedbackResultsDownloadActionTest extends BaseActionTest {
    ...
    public void testExecuteAndPostProcess() throws Exception {
        ...
        final int questionNum2 = dataBundle.getFeedbackQuestions().get("qn2InSession1InCourse1").getQuestionNumber();
        ...
        final int questionNum1 = dataBundle.getFeedbackQuestions().get("qn1InSession1InCourse1").getQuestionNumber();
