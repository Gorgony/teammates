...
public abstract class BaseActionTest extends BaseComponentTestCase {
    ...
    protected void verifyAccessibleForStudents(String[] submissionParams) {
        ...
        InstructorAttributes instructor1OfCourse1 = dataBundle.getInstructors().get("instructor1OfCourse1");
        StudentAttributes student1InCourse1 = dataBundle.getStudents().get("student1InCourse1");
        StudentAttributes otherStudent = dataBundle.getStudents().get("student1InCourse2");
    ...
    protected void verifyAccessibleForInstructorsOfTheSameCourse(String[] submissionParams) {
        ...
        InstructorAttributes instructor1OfCourse1 = dataBundle.getInstructors().get("instructor1OfCourse1");
        StudentAttributes student1InCourse1 = dataBundle.getStudents().get("student1InCourse1");
        InstructorAttributes otherInstructor = dataBundle.getInstructors().get("instructor1OfCourse2");
    ...
    protected void verifyUnaccessibleWithoutModifyCoursePrivilege(String[] submissionParams) {
        ...
        InstructorAttributes helperOfCourse1 = dataBundle.getInstructors().get("helperOfCourse1");
    ...
    protected void verifyUnaccessibleForStudentsOfOtherCourses(String[] submissionParams) {
        ...
        StudentAttributes studentInOtherCourse = dataBundle.getStudents().get("student1InCourse2");
    ...
    protected void verifyUnaccessibleForDifferentStudentOfTheSameCourses(String[] submissionParams) {
        ...
        StudentAttributes differentStudentInSameCourse = dataBundle.getStudents().get("student2InCourse1");
