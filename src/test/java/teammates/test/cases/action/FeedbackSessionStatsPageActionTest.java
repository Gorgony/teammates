...
public class FeedbackSessionStatsPageActionTest extends BaseActionTest {
    ...
    public void testExecuteAndPostProcess() {
        ...
        FeedbackSessionAttributes accessableFeedbackSession = dataBundle.getFeedbackSessions().get("session1InCourse1");
    ...
    protected void testAccessControl() throws Exception {
        InstructorAttributes instructor1OfCourse1 = dataBundle.getInstructors().get("instructor1OfCourse1");
        FeedbackSessionAttributes accessibleFeedbackSession = dataBundle.getFeedbackSessions().get("session1InCourse1");
