...
public class InstructorCourseInstructorDeleteActionTest extends BaseActionTest {
    ...
    public void testExecuteAndPostProcess() {
        InstructorAttributes loginInstructor = dataBundle.getInstructors().get("instructor1OfCourse1");
        ...
        InstructorAttributes instructorToDelete = dataBundle.getInstructors().get("instructor2OfCourse1");
        ...
        instructorToDelete = dataBundle.getInstructors().get("instructor4");
