...
public class StudentFeedbackResultsPageActionTest extends BaseActionTest {
    ...
    public void testExecuteAndPostProcess() throws Exception {
        ...
        FeedbackSessionAttributes emptySession = dataBundle.getFeedbackSessions().get("empty.session");
        FeedbackSessionAttributes closedSession = dataBundle.getFeedbackSessions().get("closedSession");
        FeedbackSessionAttributes gracePeriodSession = dataBundle.getFeedbackSessions().get("gracePeriodSession");
        ...
        dataBundle.getFeedbackSessions().get("session1InCourse1").setResultsVisibleFromTime(
                TimeHelper.now(dataBundle.getFeedbackSessions().get("session1InCourse1").getTimeZone()).getTime());
        ...
        long dataBundleResultsVisibleFromTime = dataBundle.getFeedbackSessions().get("session1InCourse1")
        ...
        expectedInfoList.add(dataBundle.getFeedbackSessions().get("session1InCourse1"));
