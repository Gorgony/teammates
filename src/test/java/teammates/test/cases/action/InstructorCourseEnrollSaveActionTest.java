...
public class InstructorCourseEnrollSaveActionTest extends BaseActionTest {
    ...
    public void testExecuteAndPostProcess() throws Exception {
        ...
        StudentAttributes modifiedStudent = dataBundle.getStudents().get("student1InCourse1");
        ...
        StudentAttributes unmodifiedStudent = dataBundle.getStudents().get("student2InCourse1");
        ...
        StudentAttributes unmodifiedStudentWithExtraSpaces = dataBundle.getStudents().get("student3InCourse1");
    ...
    protected void testAccessControl() throws Exception {
        String[] submissionParams = new String[]{
                Const.ParamsNames.COURSE_ID, dataBundle.getInstructors().get("instructor1OfCourse1").courseId,
